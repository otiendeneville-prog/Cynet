...
export const Route = createFileRoute('/')({
  head: () => ({
    meta: [
      ...
      {
        property: 'og:title',
        content: 'Cynet East Africa | Expert Training & Consultancy',
      },
      {
        property: 'og:description',
        content:
          'High-impact training, research and consultancy for organizations in East Africa.',
      },
    ],
  }),
  loader: ({ context }) => {
...
function Index() {
  const { data: featured } = useSuspenseQuery(
    coursesQuery({ featuredOnly: true }),
  )
    ...
    <div>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-5 py-20 lg:grid-cols-[1.1fr_0.9fr] lg:py-28">
          <div>
            ...
            <h1 className="mt-4 text-4xl leading-[1.05] font-bold md:text-6xl">
              Empowering <span className="text-accent">Professionals</span>{' '}
              Through Expert Training &amp; Consultancy
            </h1>
            <p className="mt-6 max-w-xl text-lg opacity-90">
              We specialize in providing high-impact training, research and
              consultancy services to individuals and organizations across
              various industries.
            </p>
      ...
      <section className="mx-auto max-w-7xl px-5 py-20">
        ...
        <p className="mt-3 max-w-2xl text-muted-foreground">
          Tailored solutions to help organizations succeed — from growth
          strategy and financial advisory to team building and research. We
          drive measurable outcomes at every stage.
        </p>
